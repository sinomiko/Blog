...
<?php if ( get_theme_mod('winterdream_display_meta_post', $winterdream_defaults['winterdream_display_meta_post']) != 'Hide' ) { ?>
        <p class="post-meta">
...
<?php endwhile; endif; ?>
<?php if ( get_theme_mod('winterdream_next_preview_post', $winterdream_defaults['winterdream_next_preview_post']) != 'Hide' ) { ?>
