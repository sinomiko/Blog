<?php
/**
 * About WinterDream admin page framework.
 * @package WinterDream
 * @since WinterDream 2.0.0
*/   

add_action('admin_init', 'winterdream_about_setup');
function winterdream_about_setup() {
$winterdream_about = array (

array( "name" => __( 'WinterDream' , 'winterdream' ),
	"type" => "title"),
...
array( "name" => "Start Tabs",
	...
	// Home
	array( "name" => __( '<i class="icon_house" aria-hidden="true"></i>Welcome' , 'winterdream' ),
			"id" => "tab_menu_0",
			"type" => "tab",
			"icon" => "layout",
  ...
  // Get Premium
	array( "name" => __( '<i class="icon_cart" aria-hidden="true"></i>GET PREMIUM' , 'winterdream' ),
			"type" => "tab",
			"id" => "tab_menu_1",
			"class" => ""),
...
array( "name" => "tab_content_0",
	...
	// Home
	array( "name" => __( 'Welcome to WinterDream!' , 'winterdream' ),
		"type" => "heading",
		"icon" => "layout"),
	
	array("name" => __( 'First of all, I would like to thank you for choosing the WinterDream theme! I firmly believe that you will be satisfied with this template.' , 'winterdream' ),
		"type" => "infotext"),
	
	array( "name" => __( 'About WinterDream' , 'winterdream' ),
		"type" => "heading",
		"icon" => "layout"),
	
	array("name" => __( 'WinterDream is an easily customizable WordPress multipurpose theme. It is a fully responsive and Retina ready theme that allows for easy viewing on any device.' , 'winterdream' ),
		"type" => "infotext"),
    
	array("name" => __( 'Since version 2.0.0, the Theme Options have been moved to the <a href="customize.php">Customizer</a>.' , 'winterdream' ),
		"type" => "infotext"),
...
array( "name" => "tab_content_1",
	...
	array( "name" => __( 'Get WinterDream Premium Version' , 'winterdream' ),
		"type" => "heading",
		"icon" => "layout"),
		
  array( "type" => "infotext",
		"name" => __( 'If you would like to purchase the WinterDream Premium Version, you can do so on <a href="http://themes.tomastoman.cz/downloads/winterdream-premium/" target="_blank">Developers Official Website</a>.' , 'winterdream' )),
    
  array( "type" => "infotext",
		"name" => __( '<strong>What the WinterDream Premium Version offers in addition?</strong><br />
    ...
    - Ability to add custom JavaScript code' , 'winterdream' )),
...
array( "type" => "close") 
); return $winterdream_about; }

add_action('admin_head', 'winterdream_admin_css');

function winterdream_admin_css() { ?>
...
<?php }
function winterdream_add_admin() {
	add_theme_page( __( 'About WinterDream' , 'winterdream' ), __( 'About WinterDream' , 'winterdream' ), 'edit_theme_options', 'about.php', 'winterdream_admin', '', '1' );
}

function winterdream_admin() {
$winterdream_about = winterdream_about_setup(); 
  wp_enqueue_style('winterdream-framework-style', get_template_directory_uri() . '/functions/about/css.css');
  wp_enqueue_style('winterdream-framework-icons', get_template_directory_uri() . '/css/elegantfont.css');
  $winterdream_manualurl = get_template_directory_uri() . '/docs/documentation.html';
?>

	<div id="wrap_fm"><!-- [ Header ]-->
		<div class="header_fm">
			<div class="logo_fm"><?php _e( 'WinterDream Theme' , 'winterdream' ); ?></div>
		</div>

		<!-- [ Top Menu ]-->
		<div class="top_menu_fm">
			<a target="_blank" class="doc_fm" href="<?php echo esc_url($winterdream_manualurl); ?>"><?php _e( 'Documentation' , 'winterdream' ); ?></a><a target="_blank" class="support_fm" href="http://themes.tomastoman.cz/support"><?php _e( 'Support' , 'winterdream' ); ?></a><a target="_blank" class="premium_fm" href="http://themes.tomastoman.cz/downloads/winterdream-premium/"><?php _e( 'Get Premium Version' , 'winterdream' ); ?></a>
		</div>

	<?php 
	foreach ($winterdream_about as $value) {
	switch ( $value['type'] ) {
	case "open":
	?> 
...
add_action('admin_menu', 'winterdream_add_admin'); ?>