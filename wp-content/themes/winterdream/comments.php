...
<div id="comments" class="comments-area<?php if ( get_theme_mod('winterdream_next_preview_post', $winterdream_defaults['winterdream_next_preview_post']) == 'Display' || get_theme_mod('winterdream_next_preview_post', $winterdream_defaults['winterdream_next_preview_post']) == '' ) { ?> comments-area-post<?php } ?>">
